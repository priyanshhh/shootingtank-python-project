...
pygame.display.set_caption('Tanks BY PRIYANSH^2')
icon = pygame.image.load("ic.jpg")
background_image=pygame.image.load("ic.jpg").convert()
...
smallfont = pygame.font.SysFont("lucida calligraphy", 25)
medfont = pygame.font.SysFont("lucida calligraphy", 50)
largefont = pygame.font.SysFont("lucida calligraphy", 85)
vsmallfont = pygame.font.SysFont("algerian", 25)
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("MADE BY: PRIYANSH^2", red, 280)
        button("Play", 150, 500, 100, 50, wheat, light_green, action="play",size="vsmall")
        button("Controls", 320, 500, 150, 50, wheat, light_yellow, action="controls",size="vsmall")
...
def game_over():
    ...
    while game_over:
        ...
        button("Controls", 350, 500, 150, 50, wheat, light_yellow, action="controls")
